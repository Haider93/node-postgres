...
app.get('/reply/:sender/:receiver/:subject/:body/:date/:time',function(req,res){
    db.query('Insert into Email(sender,receiver,subject,body,date,time) values (${sender}, ${receiver}, ${subject}, ${body}, ${date}, ${time});',{
...
app.get('/insert_to_deleted/:id/:sender/:receiver/:subject/:body/:date/:time/:deleted_by',function(req,res){
	db.one('Insert into Deleted(sender,receiver,subject,body,date,time,deleted_by) values (${sender}, ${receiver}, ${subject}, ${body}, ${date}, ${time},   ${deleted_by});',{
    id: req.params.id,
    sender: req.params.sender,
    receiver: req.params.receiver,
    subject: req.params.subject,
...
app.get('/delete/:id',function(req,res){
    db.one('delete from Email where id = ${id};',{
